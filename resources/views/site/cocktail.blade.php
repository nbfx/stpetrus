            ...
            <div class="category">
                @if($items)
                    @foreach($items as $item)
                        ...
                        <a href="{{ route('cocktailGroup', ['group' => $item['name']]) }}" class="category__item" style="background: url('{{ asset($item['preview_image'] ?? '') }}'); background-size: cover;">
