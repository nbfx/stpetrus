                                    ...
                                    @if(!empty($item['children']))
                                        @foreach($item['children'] as $childIndex => $child)
                                            <li class="list-group-item hidden-icons-container panel">
                                                ...
                                                @include('admin.parts.controlIcons', ['index' => $childIndex, 'items' => $item['children'], 'item' => $child, 'prefix' => 'wine_items'])
                                            </li>
                                        @endforeach
                                    @endif
                                    <li class="list-group-item">&nbsp;&nbsp;<a href="{{ route('wine_items_add', ['parent' => $item['id']]) }}" class="add-child">@lang('admin.add')</a></li>
                                </ul>
                            </div>
                        </div>
                    @endforeach
