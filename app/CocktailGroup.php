 ...
 */
class CocktailGroup extends Model
{
    use TableProperties;
    ...
    {
        return self::hasChildren($id) ? CocktailItem::whereParent($id)->orderBy('order')->get() : null;
    }
    ...
    {
        return !!CocktailItem::whereParent($id)->count();
    }
}
