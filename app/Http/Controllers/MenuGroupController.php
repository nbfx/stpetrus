...
class MenuGroupController extends AdminController
{
    ...
    public function __construct()
    {
        ...
        $this->setModel($this->model)
            ->setPrefix('menu_groups')
            ->setPageTitleAdd(trans('admin.pages.titles.add.menuGroups'))
            ->setPageTitleList(trans('admin.pages.titles.list.menuGroups'))
            ->setIsOrderable(true)
            ->setFields([
                'title' => [
