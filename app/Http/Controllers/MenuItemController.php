...
class MenuItemController extends AdminController
{
    ...
    public function __construct()
    {
        ...
        $this->setModel($this->model)
            ->setPrefix('menu_items')
            ->setPageTitleAdd(trans('admin.pages.titles.add.menuItems'))
            ->setPageTitleList(trans('admin.pages.titles.list.menuItems'))
    ...
    public function add()
    {
        ...
        $items = MenuGroup::orderBy('order')->get()->toArray();
    ...
    public function save(Request $request)
    {
        ...
        return redirect(route("menu_groups_list"));
    }
}
