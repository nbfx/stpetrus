...
use App\Language;
use App\SpiritGroup;
use App\SpiritItem as Model;
use Illuminate\Contracts\View\View;
use Illuminate\Http\Request;

class SpiritItemController extends AdminController
{
    private $model;
    ...
    public function __construct()
    {
        ...
        $this->setModel($this->model)
            ->setPrefix('spirit_items')
            ->setPageTitleAdd(trans('admin.pages.titles.add.spiritItems'))
            ->setPageTitleList(trans('admin.pages.titles.list.spiritItems'))
    ...
    public function add()
    {
        ...
        $items = SpiritGroup::orderBy('order')->get()->toArray();
    ...
    public function save(Request $request)
    {
        ...
        return redirect(route("spirit_groups_list"));
    }
}
