...
use App\Language;
use App\WineGroup as Model;
use App\WineGroup;
use Illuminate\Contracts\View\View;
use Illuminate\Http\Request;

class WineGroupController extends AdminController
{
    private $model;
    ...
    public function __construct()
    {
        ...
        $this->setModel($this->model)
            ->setPrefix('wine_groups')
            ->setPageTitleAdd(trans('admin.pages.titles.add.wineGroups'))
            ->setPageTitleList(trans('admin.pages.titles.list.wineGroups'))
            ->setIsOrderable(true)
            ->setFields([
                'title' => [
