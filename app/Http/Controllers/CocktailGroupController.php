...
use App\Language;
use App\CocktailGroup as Model;
use Illuminate\Contracts\View\View;
use Illuminate\Http\Request;

class CocktailGroupController extends AdminController
{
    private $model;
    ...
    public function __construct()
    {
        ...
        $this->setModel($this->model)
            ->setPrefix('cocktail_groups')
            ->setPageTitleAdd(trans('admin.pages.titles.add.cocktailGroups'))
            ->setPageTitleList(trans('admin.pages.titles.list.cocktailGroups'))
            ->setIsOrderable(true)
            ->setFields([
                'title' => [
