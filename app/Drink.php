...
class Drink extends Model
{
    ...
    {
        return self::hasChildren($id) ? DrinkGroup::whereParent($id)->orderBy('order')->get() : null;
    }
    ...
    {
        return !!DrinkGroup::whereParent($id)->count();
    }
    ...
    {
        return $this->hasMany('App\DrinkGroup', 'parent', 'id');
    }

    public function drinkItems()
    {
        return $this->hasManyThrough('App\DrinkItem', 'App\DrinkGroup', 'parent', 'parent', 'id');
    }
}
