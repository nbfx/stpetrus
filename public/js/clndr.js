...
(function (factory) {
    ...
    var clndrTemplate =
        "<div class='clndr-controls'>" +
            "<div class='clndr-elem-wrapper'>" +
                "<div class='clndr-control-button'>" +
                    "<span class='clndr-previous-button'><i class='fa fa-caret-left' aria-hidden='true'></i></span>" +
                "</div>" +
                "<div class='month'><%= month %></div>" +
                "<div class='clndr-control-button rightalign'>" +
                    "<span class='clndr-next-button'><i class='fa fa-caret-right' aria-hidden='true'></i></span>" +
                "</div>" +
            "</div>" +
            "<div class='clndr-elem-wrapper'>" +
                "<div class='clndr-control-button'>" +
                    "<span class='clndr-previous-year-button'><i class='fa fa-caret-left' aria-hidden='true'></i></span>" +
                "</div>" +
                "<div class='month'><%= year %></div>" +
                "<div class='clndr-control-button rightalign'>" +
                    "<span class='clndr-next-year-button'><i class='fa fa-caret-right' aria-hidden='true'></i></span>" +
                "</div>" +
            "</div>" +
        "</div>" +
